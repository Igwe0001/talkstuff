  ...
  return (
    <section id="contact" ref={ref} className="py-24 bg-zinc-950 dark:bg-zinc-950">
      <div className="max-w-5xl mx-auto px-6">
        <div className="bg-gradient-to-br from-zinc-900 to-black border border-white/10
          ...
          <div>
            ...
            >
              Ready to{" "}
              <span className="text-orange-500">Grow Your Brand?</span>
            </motion.h2>
            ...
            >
              ...
              increase visibility and drive real results.
            </motion.p>
