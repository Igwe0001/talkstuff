...
const Hero = () => {
  return (
    <section className="bg-heroBg w-full px-5">
      <div className="max-w-7xl w-full  mx-auto pt-10 relative flex flex-col justify-center">
        ...
        <div className="mt-20 z-[2]">
          <div className="text-center  max-w-[500px] mx-auto ">
            ...
            <h1 className="font-inter font-bold text-3xl">All in One Place</h1>
            <p className="text-textGrey text-center">
              Discover a new world where friendships flourish, connections turn
              into relationships, and shopping meets socializing
            </p>
          </div>
