    ...
    <div className="min-h-screen flex py-20 flex-col items-center justify-center bg-gray-100 px-4">
      <div className="max-w-md w-full bg-white shadow-md rounded-lg p-6">
        ...
        <p className="text-gray-600 mb-6">
          <strong>Connect with Friends</strong>: Make meaningful connections
          with friends or meet new people who share your interests. Chat
          privately or join group conversations to share ideas, laughs, and
          memories.
        </p>
        ...
        <form onSubmit={onSubmit}>
          ...
          <input
            type="hidden"
            name="_subject"
            value="🎉 New Waitlist Signup - Connect Feed"
          />
          ...
          <div className="mb-4">
            ...
            <input
              type="text"
              id="name"
              name="name" // Changed from user_name to name for Formspree
              value={name}
          ...
          <div className="mb-4">
            ...
            <input
              type="email"
              id="email"
              name="email" // Changed from user_email to email for Formspree
              value={email}
          ...
          <div className="mb-4">
            ...
            <textarea
              id="message"
              name="message" // Changed from user_message to message for Formspree
              value={message}
