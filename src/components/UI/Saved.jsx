...
const Saved = ({className}) => {
  return (
      <div className={`${className} shadow bg-white flex justify-between gap-4 items-center px-1 py-2 w-[250px] rounded-md`}>
      <div className="bg-lightGreen w-[25px] h-[25px] flex items-center justify-center rounded-md">
        <img
          className="bg-green rounded-full m-3 p-1 block w-5 h-5 z-10 object-contain"
          src={assets.check}
          alt="check"
        />
      </div>
